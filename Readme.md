[![Build and test the esy package](https://github.com/ManasJayanth/esy-libpng/actions/workflows/workflow.yml/badge.svg)](https://github.com/ManasJayanth/esy-libpng/actions/workflows/workflow.yml)
